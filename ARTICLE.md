...
最初，老婆一直是用微信里别人做的一个现成小程序来记录（当时觉得只要能简单打卡就行）：

![之前使用的现成第三方小程序打卡界面](docs/screenshots/img_dashboard.png)
...
这一句话，直接把需求从“将就用别人的小程序”推向了“自己打造工业级全功能 Pro 站”。  
**在现代 AI（如 Antigravity / Claude 3.5 / GPT-4o）的加持下，我没有手写繁重的底层逻辑，而是通过几轮精准的 Prompt 交互，让 AI 在几个小时内帮我全栈从零打造出了这套「姨妈日历 Pro 版」！**
